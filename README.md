...
[![Daily Digest](https://github.com/SamadhiFire/podcast-distill-miaowu-external/actions/workflows/daily-digest.yml/badge.svg)](https://github.com/SamadhiFire/podcast-distill-miaowu-external/actions/workflows/daily-digest.yml)
[![Feishu Wiki](https://img.shields.io/badge/Knowledge%20Base-Feishu%20Wiki-blue?logo=lark)](https://my.feishu.cn/wiki/space/7655607441056337129)
...
<img src="docs/assets/feishu-knowledge-base-qr.png" width="220" alt="半脑互搏飞书知识库二维码" />
...
- **优雅的双层 Wiki 归档**：自动归入飞书知识库「🎧 播客蒸馏室」，按日期自然降序排布，永不产生重复节点。
...
```mermaid
flowchart LR
    A[信源抓取<br/>小宇宙 / YouTube] --> B[文本提取与 ASR<br/>通义听悟 / 字幕中转]
    B --> C{质检门禁<br/>覆盖率 ≥ 95%}
    C -->|通过| D[LLM 结构化蒸馏<br/>契约化多维提炼]
    C -->|未达标| X[阻止发布 / 报警]
    D --> E[飞书 OpenAPI<br/>发布 Wiki & 知识库]
    E --> F[飞书群机器人<br/>推送晨报卡片]
```
